import { useState, useEffect, useRef } from 'react'; //importerar useState, useEffect och useRef, useState för att hantera state variabler, useEffect för att köra biverkningar som att starta och stoppa timer, useRef för att skapa en referens som kvarstår mellan renderingar utan att orsaka omrenderingar 
...
const timerRef = useRef(null); //Skapar en referens för att lagra timer id, används för att inte skapa omrenderingar när timerRef ändras
